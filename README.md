...
- **Veridis — Corn and Beet Crop Monitoring Dataset** — 10,080 RGB images of corn and beet fields captured by a ground robot equipped with an Intel RealSense D455 camera, annotated with bounding boxes in YOLO format across 2 classes (beet, corn). Images were collected under natural daylight conditions across 27 field sessions in León, Spain. The dataset includes augmented versions created through geometric and photometric transformations, and privacy protection via automated person anonymization. Raw ROS 2 bag files with depth data are also available. [Data](https://doi.org/10.57967/hf/6907), [Paper](https://doi.org/10.1016/j.dib.2026.112820)
### Disease and Plant Health datasets
...
- **CropAndWeedAndLeaf** — A leaf-level instance segmentation benchmark derived from the CropAndWeed dataset, with images cropped to individual plant instances and enhanced with pixel-level leaf masks across 23 plant species (including maize, sugar beet, potato, soybean, sunflower, and 18 weed species). Annotations are provided in YOLOv8 instance-segmentation format. Introduced alongside the ReLeaf benchmark to evaluate cross-domain and cross-species generalization of modern instance-segmentation architectures for fine-grained plant analysis tasks such as crop health assessment and growth stage estimation. [Data](https://doi.org/10.5281/zenodo.20116408), [Paper](https://doi.org/10.48550/arXiv.2605.03784), [Code](https://github.com/cropandweed/releaf)
### Agricultural Objects datasets
- **BaleUAVision**: 2,599 high-resolution UAV RGB images (4056×3040) of 16 hay bale fields in northern Greece, with per-instance polygon annotations (COCO, CSV, JSON, YOLO, and mask formats), accompanying orthophotos, and manual bale counts. Covers ~938,715 m² at 1.53–3.06 cm/pixel GSD, useful for hay bale detection, instance segmentation, and counting in precision agriculture — [Data](https://doi.org/10.5281/zenodo.15304714), [Code](https://github.com/georkara/BaleUAVision), [Paper](https://doi.org/10.1038/s41597-026-06622-8)
